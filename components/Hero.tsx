      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        ...
        <div className="animate-hero-cta">
          <a
            ...
            className="inline-flex items-center gap-3 bg-rt-green hover:bg-rt-green-deep text-white font-semibold text-base px-8 py-4 rounded-full transition-all duration-300 hover:scale-[1.03] hover:shadow-[0_4px_32px_rgba(141,180,47,0.45)]"
          >
            <WaIcon />
            Hablá con Bastó
          </a>
